#!/usr/bin/env bash
# macOS double-click wrapper for the handoff installer.

set -u

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo "handoff Installer"
echo
echo "Drag the project folder into this Terminal window, then press Enter."
echo "The installer will add the /handoff command and the handoff skill."
...
"$ROOT/install-handoff.sh" "$TARGET"
