#!/usr/bin/env bash
# macOS double-click wrapper for the simplify installer.
...
echo "The installer will add the /simplify and /code-smell commands and the simplify skill tree."
...
"$ROOT/install-simplify.sh" "$TARGET"
