---
description: Scan a path or area of code for structural smells (complexity, duplication, coupling, state, errors, performance, maintainability) ranked by severity and confidence. Detect-only — never edits code. Use to survey an area before refactoring.
argument-hint: "<path-or-area> [focus]"
---
...
> changed-lines review with a verdict. Hand the safe subset of these findings to `/simplify`.
